class UsersController < ApplicationController
    ...
    before_action :require_admin, only: [:admin, :destroy, :index]
    ...
    def require_same_user
        if current_user != @user
            flash[:alert] = "You are not authoruized to do this actions. You can only edit or update your own account"
